          ...
          <div className="space-y-20 mt-12">
            ...
            >
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-sage/80 text-lg">
                  Sign up and build your student profile. Upload your skills,
                  certifications, and showcase your past work to stand out to
                  potential clients.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-sage/80 text-lg">
                  Browse through job postings and task requests from clients
                  looking for services like video editing, logo design, coding,
            ...
            >
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-sage/80 text-lg">
                  The app bridges the gap between you and clients. Apply for
                  jobs, discuss requirements, and build professional
                  relationships directly through the platform.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-sage/80 text-lg">
                  ...
                  Clients pay Skull, and Skull pays you, ensuring safe and
                  timely transactions for your work.
                </p>
              </div>
            </div>
          </div>
